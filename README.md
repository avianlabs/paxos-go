...
*SandboxFiatTransfersAPI* | [**CreateFiatAccount**](docs/SandboxFiatTransfersAPI.md#createfiataccount) | **Post** /transfer/fiat-accounts | Create Fiat Account
*SandboxFiatTransfersAPI* | [**CreateFiatDepositInstructions**](docs/SandboxFiatTransfersAPI.md#createfiatdepositinstructions) | **Post** /transfer/fiat-deposit-instructions | Create Fiat Deposit Instructions
*SandboxFiatTransfersAPI* | [**CreateFiatWithdrawal**](docs/SandboxFiatTransfersAPI.md#createfiatwithdrawal) | **Post** /transfer/fiat-withdrawals | Create Fiat Withdrawal
*SandboxFiatTransfersAPI* | [**DeleteFiatAccount**](docs/SandboxFiatTransfersAPI.md#deletefiataccount) | **Delete** /transfer/fiat-accounts/{id} | Delete Fiat Account
*SandboxFiatTransfersAPI* | [**GetFiatAccount**](docs/SandboxFiatTransfersAPI.md#getfiataccount) | **Get** /transfer/fiat-accounts/{id} | Get Fiat Account
*SandboxFiatTransfersAPI* | [**GetFiatDepositInstructions**](docs/SandboxFiatTransfersAPI.md#getfiatdepositinstructions) | **Get** /transfer/fiat-deposit-instructions/{id} | Get Fiat Deposit Instructions
...
*SandboxFiatTransfersAPI* | [**ListFiatAccounts**](docs/SandboxFiatTransfersAPI.md#listfiataccounts) | **Get** /transfer/fiat-accounts | List Fiat Accounts
*SandboxFiatTransfersAPI* | [**ListFiatDepositInstructions**](docs/SandboxFiatTransfersAPI.md#listfiatdepositinstructions) | **Get** /transfer/fiat-deposit-instructions | List Fiat Deposit Instructions
*SandboxFiatTransfersAPI* | [**UpdateFiatAccount**](docs/SandboxFiatTransfersAPI.md#updatefiataccount) | **Put** /transfer/fiat-accounts/{id} | Update Fiat Account
...
## Documentation For Models
 ...
 - [InstitutionDetailsCIPIDType](docs/InstitutionDetailsCIPIDType.md)
