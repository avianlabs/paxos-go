...
// APIClient manages communication with the Paxos API API v2.0
...
type APIClient struct {
	...
	QuoteExecutionsAPI *QuoteExecutionsAPIService

	QuotesAPI *QuotesAPIService

	SandboxDepositsAPI *SandboxDepositsAPIService

	SandboxFiatTransfersAPI *SandboxFiatTransfersAPIService
